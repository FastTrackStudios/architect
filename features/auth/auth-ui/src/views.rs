...
pub fn OrgView(
    ...
    // Name and slug still feed the settings form; the role is on the
    // page heading now rather than repeated in the body.
    let _ = my_role;
    rsx! {
        FlashLine { flash }
                    ...
                    tbody {
                        for member in members.iter() {
                            tr { key: "{member.user_id}",
                                td {
                                    strong { "{member.name}" }
                                    span { class: "handle mono", "{member.email}" }
                                }
                                td {
                                    if can_invite {
        ...
        if can_invite {
            section { class: "panel",
                ...
                p { class: "hint", "Creates a link addressed to one person. It can be accepted once." }
        ...
        section { class: "panel",
            ...
            p { class: "hint",
                if is_owner {
                    "Deleting takes the members, teams, invitations and links with it. There is no undo."
                } else {
                    "You can rejoin later if somebody invites you again."
                }
            }
